...
class TestJpfold(unittest.TestCase):
    ...
    def test_one_line_break_complex_case(self):
        ...
        self.assertEqual(nextline, "")
        origline, nextline = jpfold.one_line_break('    <img class="photo" src="https://www.yukinobu.jp/tdiary-v5.1.4-test/images/20210102_0.jpg" alt="画像の説明" title="画像の説明" width="1848" height="2157">', 66)
        self.assertEqual(origline, '    <img class="photo" src=')
        self.assertEqual(nextline, '    "https://www.yukinobu.jp/tdiary-v5.1.4-test/images/20210102_0.jpg" alt="画像の説明" title="画像の説明" width="1848" height="2157">')
        origline, nextline = jpfold.one_line_break('    "https://www.yukinobu.jp/tdiary-v5.1.4-test/images/20210102_0.jpg" alt="画像の説明" title="画像の説明" width="1848" height="2157">', 66)
        self.assertEqual(origline, '    "https://www.yukinobu.jp/tdiary-v5.1.4-test/images/20210102_0.jpg" ')
        self.assertEqual(nextline, '    alt="画像の説明" title="画像の説明" width="1848" height="2157">')
        origline, nextline = jpfold.one_line_break("はチェック", 4)
        self.assertEqual(origline, "はチェッ")
        self.assertEqual(nextline, "ク")
